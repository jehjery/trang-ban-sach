 ...
 <section class="header">
		...
		<div>
			<ul class="navbar">
				...
				<li><a class="active" href="ADMINBLOGcontroller">BLOG</a></li>
...
<div class="add-product">
				<a href="themblog.jsp">+ ADĐ More</a>
			</div></tr>
  <section class="blog">
 	 <%
    ...
    <div class="blog-box">
      ...
      <div class="blog-details">
        ...
        <h4><%=l.getTieude()%>/<%=l.getTacgia() %></h4>
        <p><%=l.getPhude() %></p>
       <span><%=l.getNoidung() %></span>
      </div>
       <a href="XOABLOG?mablog=<%=l.getMablog()%>">=============XÓA============</a>
      <h1>13/01</h1>
    </div>
    	<% };%>
  </section>
