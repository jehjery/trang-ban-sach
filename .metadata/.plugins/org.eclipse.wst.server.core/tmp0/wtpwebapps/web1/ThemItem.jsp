...
<section class="vh-100">
	<div class="container">
		<div class="panel panel-primary">
			...
			<form action="ThemItem"method="post">
			<div class="panel-body">
				...
				<div class="form-group">
				  ...
				  <input 
				  name= "Tensanpham" required="true" type="text" class="form-control" id="usr">
				</div>
				
						<div class="form-group">
				  <label for="usr">Mã sản phẩm:</label>
				  <input 
				  name= "masanpham" required="true" type="text" class="form-control" id="usr">
				</div>
				<div class="form-group">
				  <label for="usr">Nguồn Gốc:</label>
				  <input
