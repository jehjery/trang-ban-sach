...
.container-fluid{
  ...
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav ">
      ...
      <li><a href="lichsuhoadon">lịch sử mua hàng</a></li>
      <li>
              ...
              <nav class="category">
                ...
                <ul class="category-list">
                  <li class="category-item category-item--active">
                    <a href="#" class="category-item__link">Khoa hoc</a>
                  
				<%	   
					
				    ArrayList<loaibean> listloai = (ArrayList<loaibean>)request.getAttribute("loaisach");
				   for(loaibean l: listloai){ %>
					<%if (l.getTenloai()!=null){ %>
					<tr><td>
					<li  class="category-item ">
					<a class="category-item__link" href="timkiem?maloai=<%=l.getMaloai()%>" >
						<%= l.getTenloai()%></a><% }%>
					</li><%} %> 
                  ...
                  <div class="col l-2-4 m-4 c-6">
                    <a href="#" class="home-product-item">
                      ...
                      <div class="home-product-item__origin">
                        ...
                        <form action="dathang"method="post" style="margin: -2px;">
						<button style="color: red;
    					background: gold;" value="<%=s.getMasach() %>" 
    					name="dathang"type="submit">Đặt Hàng</button>
						</form>
						</span
                        >
                      </div>
