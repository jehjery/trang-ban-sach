		...
		<div>
			<ul class="navbar">
				...
				<li class="use-Avatar"><i class="fa fa-user-circle Avatar"
					...
					<li><a class="active" href="dangky">sign up</a></li>	
					</ul>
					</li>
		...
		<div class="panel panel-primary">
			...
			<div class="panel-body">
				<div class="form-group">
				  ...
				  <input name= "username" placeholder="tên đăng nhập" required="true" type="text" class="form-control" id="usr">
				</div>
				...
				<div class="form-group">
				  ...
				  <input name="fullname" type="text" class="form-control" id="address"placeholder="fullname">
				</div>
				 
				 <div class="form-group">
				  <label for="email">Email:</label>
				  <input name="email" required="true" type="email" class="form-control" id="email"placeholder="123@gmail.com">
				</div> 
				
				<div class="form-group">
				  <label for="male">Gender</label>
				  <input name="gioitinh" type="text" class="form-control" id="address"placeholder="Nam/Nữ:">
				</div>
				
				<div class="form-group" style="display: flex;">
				  <label for="birthday">Birthday:</label>
				  <input name="ngay" type="number" class="form-control" id="birthday" placeholder="ngay">
				  <input name="thang" type="number" class="form-control" id="birthday"placeholder="thang">
				  <input name="nam" type="number" class="form-control" id="birthday" placeholder="nam">
				</div> 
