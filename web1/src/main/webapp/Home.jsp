 ...
 <h2>Featured Products</h2>
    <p>Summer Collection New Morden Design</p>
		<div class="category">
			...
			<h3><%=a.getTenloai()%></h3>
							<%}%>
			<%}%>
			<select class="category-config">
				<label class="category-product">Khác</label>
				<option class="category-product" style="text-align: center;" label="Toàn Bộ">...</option>
			<% for (loaibean x: listloai){%>
				<option class="category-product" label="<%=x.getTenloai() %>"></option>
			<%}%>	
			</select>
			<%}%>
			<div class="add-product">
				<a href="SHOPcontroller">+Go More</a>
			</div>
		</div>
	...
	<section class="sm-banner section-p1">
		<div class="banner-box">
			...
			<button class="while">Learn More</button>
		</div>
		<div class="banner-box banner-box2">
			<h4>Spring/Summer</h4>
			<h2>Upcomming season</h2>
			<span>The best classic dress is on sale at cara</span>
			<button class="while">Collection</button>
		</div>
	</section>
	...
	<footer class="section-p1">
		...
		<div class="col">
			<h4>My Account</h4>
			<a href="#">Account</a> <a href="#">Sign In</a> <a href="#">View
				Cart</a> <a href="#">My Wishlist</a> <a href="#">Track My Order</a> <a
				href="#">Help</a>
		</div>
		...
		<div class="col install">
			...
			<div class="row">
				<img src="img/pay/app.jpg" alt=""> <img src="img/pay/play.jpg"
					alt="">
			</div>
