 ...
 <section class="header">
		...
		<div>
			<ul class="navbar">
				...
				<li><a class="active" href="ADMINBUILDcontroller">BUILD</a></li>
    ...
    <table width="100%">
      <thead>
        <tr>
          ...
          <td>PRICE</td>
          <td>VOUCHER </td>
          <td>BANKING/SUCCESS</td>
        </tr>
      </thead>
      <tbody>
 <% if(request.getAttribute("listhd")!=null){
 		ArrayList<hoadonbean> listhd = (ArrayList<hoadonbean>) request.getAttribute("listhd");
	for(hoadonbean aa: listhd){	
	%>  
        <tr>
          <td><a href="XoaBUILD?ngay=<%=aa.getNgaythanhtoan()%>"><i class="far fa-times-circle"></i></a></td>
          <td><a href="Xemchitiet?ngay=<%=aa.getNgaythanhtoan()%>"><%=aa.getNgaythanhtoan() %></a></td>
          <td><%=aa.getNguoimua()%></td>
          <td><%=aa.getSotien()/20000%>$ ~ <%=aa.getSotien()%> VND</td>
		  <td><%=aa.getVoucher()%></td>
          <td><%=aa.getBanking()%> / <a href="XongBUILD?ngay=<%=aa.getNgaythanhtoan()%>&name=<%=aa.getNguoimua()%>""><i class="far fa-times-circle"></i></a></td>
        </tr>
       <%} %>
        <%} %>
      </tbody>
