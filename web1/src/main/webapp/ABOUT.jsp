...
<body>
  <section class="header">
		...
		<div>
			<ul class="navbar">
				...
				<li><a class="active" href="ABOUTcontroller">About</a></li>
  ...
  <section class="about-head section-p1">
    ...
    <div>
      <h2>Who We Are?</h2>
      <p>Lorem ipsum dolor sut amet, consectetur adipisicing elit, sed do eiusmod tepor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam. quis nostrud exercitation ullamco laboris nisi ut aliquip ex ae commodo consequat. Duis auteirure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cup idatat non proident, sunt in culpa qui officia deserent mollit anim id est laborum. </p>
      <abbr title="">Create stunning images with as much or as litter control as you like thanks to a choice of basic and Creative modes</abbr>

      <br><br>

      <marquee bgcolor="#ccc" loop="-1" scrollamount="5" width="100%">Create stunning iamges with as much or as little control as you like thanks to a choice of Basic and Creative modes.</marquee>
    </div>
  </section>

  <section class="about-app section-p1">
    <h1>Download Our <a href="https://play.google.com/store/apps/details?id=com.gohidoc.cara&hl=vi&gl=US">App</a></h1>
    <div class="video">
