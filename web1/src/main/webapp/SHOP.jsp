...
<body>
  <section class="header">
		...
		<div>
			<ul class="navbar">
				...
				<li><a class="active" href="SHOPcontroller">Shop</a></li>
  ...
  <section class="product1 section-p1">
    <div class="category">
			...
			if (a.getsoluongsanpham()!=0){
				%>
			<h3><a class= "danhmuc"href="TimKiemcontroller?maloai=<%=a.getMaloai()%>"><%=a.getTenloai()%></a></h3>
							<%}%>
					<%}%>
  ...
  <section class="pagination section-p1">
		...
		%>
    <a href="SHOPcontroller?page=<%=i%>"><%=i%></a>
	<%} %>
    <a href="SHOPcontroller?page=<%=page1+1%>"><i class="next fal fa-long-arrow-alt-right"></i></a>
  </section>
