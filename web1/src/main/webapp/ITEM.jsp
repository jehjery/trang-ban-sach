 ...
 <section class="header">
		...
		<div>
			<ul class="navbar">
				...
				<li><a  href="ADMINcontroller">User</a></li>
				<li><a  href="LOAIcontroller">Type</a></li>
				<li><a class="active" href="ITEMcontroller">Item</a></li>
				<li><a href="ADMINBUILDcontroller">BUILD</a></li>
				<li><a href="ADMINBLOGcontroller">BLOG</a></li>
				<li><a  href="COMMENTcontroller">COMMENT</a></li>
				<li><a  href="ktdn">OUT</a></li>
  ...
  <section class="page-header blog-header">
    ...
    <p>reseting the page</p>
  </section>
<section class="cart section-p1">
    <table width="100%">
      <thead>
      	<tr><div class="add-product">
				<a href="ThemItem.jsp">+ ADĐ More</a>
			</div></tr>
        <tr>
        <tr>
           <td>Xóa</td>
          <td>Ảnh</td>
         <td>mã sp/tên sp/mã loại</td>
          <td>giá/ sô lượng còn / Nguồn gốc</td>
          <td>Chinh Sua</td>
 ...
 <% if(request.getAttribute("sp")!=null){
 		ArrayList<sanphambean> listhd = (ArrayList<sanphambean>) request.getAttribute("sp");
	for(sanphambean aa: listhd){	
	%>  
        <tr>
          <td><a href="XoaItem?un=<%=aa.getMasp()%>"><i class="far fa-times-circle"></i></a></td>
          <td><img alt="" src="<%=aa.getAnh()%>"></td>
          <td><%=aa.getMasp()%>/<%=aa.getTensp()%>/<%=aa.getMaloai()%></td>
           <td><%=aa.getGia()%>VND / <%=aa.getSoluong() %> ITEMS / <%=aa.getNguongoc()%></td>
           <td><a href="SuaItem.jsp?masach=<%=aa.getMasp()%>&maloai=<%=aa.getMaloai()%>&Tensach=<%=aa.getTensp()%>&tacgia=<%=aa.getNguongoc()%>&soluong=<%=aa.getSoluong() %>&gia=<%=aa.getGia() %>&anh=<%=aa.getAnh()%>"><i class="far fa-times-circle"></i></a></td>
